...
mi xeq 1: quietly xtmixed pocschoolprop inquiry prop primary middle high lnage lnstudents urban pctpdfs || _all:R.cmoname || _all:R.state || geodistrict: , nolog cov(unstructured) ; xtmrho
